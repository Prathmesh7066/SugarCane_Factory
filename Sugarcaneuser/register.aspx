		...
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign Up</div>
		    <form runat="server">
			  ...
			  <label for="exampleInputEmailId">Email Id</label>
			   <div class="position-relative has-icon-right">
				  <%--<input type="text" id="exampleInputEmailId" class="form-control input-shadow" placeholder="Enter Your Email ID">--%>
                   <asp:TextBox ID="txtemail" class="form-control input-shadow" placeholder="Enter Mobile No" runat="server"></asp:TextBox>
				  <div class="form-control-position">
					  <i class="zmdi zmdi-phone"></i>
				  </div>
			   </div>
		  ...
		  <div class="card-footer text-center py-3">
		    <p class="text-warning mb-0">Already have an account? <a href="login.aspx"> Sign In here</a></p>
		  </div>
	     </div>
