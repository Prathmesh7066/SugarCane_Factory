<%@ Page Title="" Language="C#" MasterPageFile="~/Sugercaneadmin/farmer.master" AutoEventWireup="true" CodeFile="farmer_enquiry.aspx.cs" Inherits="Sugercaneadmin_farmer_enquiry" %>
            ...
            <asp:GridView ID="GridView1" class="table table-bordered" AutoGenerateColumns="false" runat="server">
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <HeaderTemplate>Enquiry ID Number</HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblenq" runat="server" Text='<%# Eval("enquiry_id") %>'></asp:Label>
                    ...
                    <asp:TemplateField>
                      ...
                      <asp:TemplateField>
                        ...
                        <HeaderTemplate> Enquiry solved</HeaderTemplate>
                        <ItemTemplate>
                            
                            <asp:Button ID="btnverify" runat="server" class="btn" Text="Solved" OnClick="btnverify_Click" />
                        </ItemTemplate>
