<%@ Page Title="" Language="C#" MasterPageFile="~/Sugercaneadmin/farmer.master" AutoEventWireup="true" CodeFile="accountant_table.aspx.cs" Inherits="Sugercaneadmin_accountant_table" %>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Accountant Details </h5>
            ...
            <asp:GridView ID="GridView1" class="table table-bordered" AutoGenerateColumns="false" runat="server">
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("accountant_id") %>'></asp:Label>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("accountant_name") %>'></asp:Label>
                           <%-- <asp:Image ID="Image1" ImageUrl='<%# Eval("photo_id") %>' runat="server" />--%>
                        </ItemTemplate>
                    </asp:TemplateField>
