...
public partial class Sugercaneadmin_fillman : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string dir = "fillmanimg";
            dirpath = dir + FileUpload1.FileName;
            FileUpload1.SaveAs(Server.MapPath(dirpath));
        }

        SqlCommand cmd = new SqlCommand("insert into fillmantable(fillman_name,contact_no,email_id,aadhar_no,village,photo_id) values (@fillman_name,@contact_no,@email_id,@aadhar_no,@village,@photo_id)", con);
        cmd.Parameters.AddWithValue("@fillman_name", txtnm.Text);
        ...
        using (MailMessage mm = new MailMessage("prathmeshedake87@gmail.com", nm))
        {
            ...
            smtp.Port = 587;
            smtp.Send(mm);
            ClientScript.RegisterStartupScript(GetType(), "alert", "alert('register succsesfully');", true);
        }
