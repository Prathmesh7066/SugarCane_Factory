<%@ Page Title="" Language="C#" MasterPageFile="~/Sugercaneadmin/farmer.master" AutoEventWireup="true" CodeFile="weightman_registration.aspx.cs" Inherits="Sugercaneadmin_weightman_registration" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Weight Details</div>
           <hr>
            <form>
