...
public partial class Sugercaneadmin_accountant_registration : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into accountant_registration(accountant_name,contact_no,email_id,aadhar_no,village,photo_id) values (@accountant_name,@contact_no,@email_id,@aadhar_no,@village,@photo_id)", con);
        cmd.Parameters.AddWithValue("@accountant_name", txtnm.Text);
