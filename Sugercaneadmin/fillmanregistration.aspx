<%@ Page Title="" Language="C#" MasterPageFile="~/Sugercaneadmin/farmer.master" AutoEventWireup="true" CodeFile="fillmanregistration.aspx.cs" Inherits="Sugercaneadmin_fillman" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Fillman Details</div>
           <hr>
            <form>
           ...
           <div class="form-group">
            ...
            <%--<input type="text" class="form-control" id="input-3" placeholder="Enter Your Mobile Number">--%>
               <asp:TextBox ID="txtemail" class="form-control" runat="server" placeholder="Enter Email ID" ></asp:TextBox>
                ...
                <div class="form-group">
            <label for="input-3">Village</label>
            <%--<input type="text" class="form-control" id="input-3" placeholder="Enter Your Mobile Number">--%>
