<%@ Page Title="" Language="C#" MasterPageFile="~/sugarcanefillman/farmer.master" AutoEventWireup="true" CodeFile="fillmanbooking.aspx.cs" Inherits="sugarcanefillman_fillman_booking" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Button ID="btnverify" runat="server" class="btn" Text="Verify" OnClick="btnverify_Click" />
                        </ItemTemplate>
                    </asp:TemplateField>
