...
public partial class sugarcanefillman_fillman_booking : System.Web.UI.Page
{
    ...
    void binddata()
    {
        SqlCommand cmd = new SqlCommand("select * from booking where sugercanecomplete='waiting' and village='" + Session["vill"] + "'",con);
        con.Open();
    ...
    protected void btnverify_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("update booking set sugercanecomplete='Complete' where bookingid=@fnm", con);
