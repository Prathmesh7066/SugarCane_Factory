<%@ Page Title="" Language="C#" MasterPageFile="~/sugarcanefillman/farmer.master" AutoEventWireup="true" CodeFile="sugercane_complete_verify.aspx.cs" Inherits="sugarcanefillman_fillman_booking" %>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Sugercane Complete Verification </h5>
            ...
            <asp:GridView ID="GridView1" class="table table-bordered" AutoGenerateColumns="false" runat="server">
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <HeaderTemplate>Sugercane Complete Verification</HeaderTemplate>
                        <ItemTemplate>
                            
                            <asp:Button ID="btnverify" runat="server" class="btn" Text="Complete" OnClick="btnverify_Click" />
                        </ItemTemplate>
                    </asp:TemplateField>
