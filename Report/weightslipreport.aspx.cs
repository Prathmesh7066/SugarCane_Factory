...
public partial class Report_weightslipreport : System.Web.UI.Page
{
    ...
    void reportbind()
    {
        //SqlCommand cmd = new SqlCommand("SELECT * from sugarcane_weight_slip where slip_date=@date", con);
        //cmd.Parameters.AddWithValue("@date", Convert.ToDateTime(txtdate.Text));
        //SqlDataAdapter da = new SqlDataAdapter(cmd);
        //DataTable dt = new DataTable("sugarcane_weight_slip");
        //da.Fill(dt);

        //ReportViewer1.ProcessingMode = ProcessingMode.Local;
        //ReportViewer1.LocalReport.ReportPath = Server.MapPath("weightslipReport.rdlc");
    ...
    protected void Calendar1_SelectionChanged(object sender, EventArgs e)
    {
        ...
        //query
        SqlCommand cmd = new SqlCommand("SELECT * from sugarcane_weight_slip where slip_date=@date", con);
        cmd.Parameters.AddWithValue("@date", MyString_new);
        SqlDataAdapter da = new SqlDataAdapter(cmd);
        DataTable dt = new DataTable("sugarcane_weight_slip");
        da.Fill(dt);
